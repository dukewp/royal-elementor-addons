...
class Wpr_Particles {
	...
	public function array_of_particles() {  
		return [
			...
			'pentagon' => '{"particles":{"number":{"value":38,"density":{"enable":true,"value_area":800}},"color":{"value":"#000000"},"shape":{"type":"polygon","stroke":{"width":0,"color":"#000"},"polygon":{"nb_sides":6},"image":{"src":"img/github.svg","width":100,"height":100}},"opacity":{"value":0.3,"random":true,"anim":{"enable":false,"speed":1,"opacity_min":0.1,"sync":false}},"size":{"value":39.459250432078804,"random":false,"anim":{"enable":true,"speed":10,"size_min":40,"sync":false}},"line_linked":{"enable":false,"distance":200,"color":"#000000","opacity":1,"width":2},"move":{"enable":true,"speed":8,"direction":"none","random":false,"straight":false,"out_mode":"out","bounce":false,"attract":{"enable":false,"rotateX":600,"rotateY":1200}}},"interactivity":{"detect_on":"canvas","events":{"onhover":{"enable":false,"mode":"grab"},"onclick":{"enable":false,"mode":"push"},"resize":true},"modes":{"grab":{"distance":400,"line_linked":{"opacity":1}},"bubble":{"distance":400,"size":40,"duration":2,"opacity":8,"speed":3},"repulse":{"distance":200,"duration":0.4},"push":{"particles_nb":4},"remove":{"particles_nb":2}}},"retina_detect":true}',
	...
	public function register_controls( $element, $section_id, $args ) {
		...
		if ( ( 'section' === $element->get_name() && 'section_background' === $section_id ) ) {
			...
			$element->add_control (
				...
				[
					...
					'options' => [
						...
						'wpr_particle_json_custom'  => __( 'Custom Styles', 'plugin-domain' ),
					],
					'condition' => [
						'wpr_enable_particles' => 'yes'
					]
			...
			$element->add_control (
				'particles_shape',
				[
					'label' => __( 'Particle Shape', 'plugin-domain' ),
					'type' => Controls_Manager::SELECT,
					'default' => 'circle',
					'options' => [
			...
			$element->add_control(
				'particles_size',
				[
					'label' => __( 'Particle Size', 'wpr-addons' ),
					'type' => \Elementor\Controls_Manager::NUMBER,
					'min' => 0,
					'max' => 500,
					'step' => 2,
