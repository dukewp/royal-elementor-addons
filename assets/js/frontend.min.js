	...
	var WprElements = {
		...
		widgetFlipCarousel: function($scope) {
			...
			$('.wpr-flip-carousel').flipster({
				...
				touch: flipsterSettings.play_on_touch === 'yes' ? true : false,
				...
				buttons: flipsterSettings.enable_navigation !== 'yes' ? false : flipsterSettings.prev_next_navigation === 'default' ? true : flipsterSettings.prev_next_navigation,
