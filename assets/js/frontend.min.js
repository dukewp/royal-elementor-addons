( function( $, elementor ) {
	...
	var WprElements = {
        ...
        widgetImageAccordion: function($scope) {
			console.log($scope.find( '.wpr-img-accordion-media-hover' ).attr( 'data-settings' ));
			...
			if ( 'hover' === settings.activeItem.interaction) {
				...
				accordionItem.on('click', '.wpr-img-accordion-media-hover', function() {
					accordionItem.removeClass('wpr-image-accordion-item-grow');
			...
			// var lightbox = $scope.find( '.wpr-img-accordion-item-lightbox' );
			
			// lightbox.find( '.inner-block > span' ).on( 'click', function(e) {
			// 	e.preventDefault();
			// 	console.log('event target detected');
			// 	if ( ! WprElements.editorCheck() ) {
			// 		var imageWrap = $(this).closest( '.wpr-img-accordion-media-hover' );
			// 			imageWrap.trigger( 'click' );
			// 	} else {
			// 		alert( 'Lightbox is Disabled in the Editor!' );
			// 	}
