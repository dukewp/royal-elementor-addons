	...
	var WprElements = {
		...
		widgetNavMenu: function( $scope ) {
			...
			var subMenuFirst = $navMenu.find( '.wpr-nav-menu > li.menu-item-has-children' ),
				subMenuDeep = $navMenu.find( '.wpr-sub-menu' ).find('li.menu-item-has-children');
        ...
        widgetImageAccordion: function($scope) {
			...
			function mediaHoverLink() {
				if ( ! WprElements.editorCheck() ) {
					...
					MediaWrap.on( 'click', function( event ) {
			...
			if ( 'hover' === settings.activeItem.interaction) {
				...
				accordionItem.on('click', '.wpr-img-accordion-media-hover', function(event) {
					console.log(event.target.className.includes('wpr-animation-wrap-active'));
					console.log($(this).hasClass('wpr-animation-wrap-active'));
					console.log(event.target.className);
					console.log($(this).attr('class'));
					var thisTargetHasClass = event.target.className.includes('wpr-img-accordion-media-hover') ? event.target.className.includes('wpr-animation-wrap-active') : $(this).closest('.wpr-img-accordion-media-hover').hasClass('wpr-animation-wrap-active');
