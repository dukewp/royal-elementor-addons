	...
	var WprElements = {
		...
		init: function() {
			...
			var widgets = {
				...
				'wpr-product-mediaflex.default' : WprElements.widgetProductMediaFlex,
		...
		widgetProductMediaFlex: function( $scope ) {

			var sliderIcons = $scope.find('.wpr-product-media-wrap').data('slider-arrows');

			console.log($scope.find('.wpr-product-media-wrap').data('slider-arrows'));
		...
		widgetProductMiniCart: function($scope) {
				...
				$scope.find('.wpr-mini-cart-toggle-btn').on('click', function(e) {
					...
					if(displayMiniCart == false) {
						...
						$scope.find('.wpr-mini-cart').css({"display": "block"});
					}
				});
