( function( $, elementor ) {
	...
	var WprElements = {
		...
		widgetSection: function( $scope ) {
			...
			var WprEqualHeightHandler = function ($scope) {

				if (!$scope.hasClass("wpr-equal-height-yes"))
					return;

				WprEqualHeight($scope);
			}
			...
			elementorFrontend.hooks.addAction("frontend/element_ready/section", WprEqualHeightHandler);
			elementorFrontend.hooks.addAction("frontend/element_ready/container", WprEqualHeightHandler);
