		...
		widgetGrid: function( $scope ) {
			...
			// Slider
				...
				var sliderClass = $scope.attr('class'),
					...
					sliderColumnsTablet = sliderClass.match(/tablet\d/) ? sliderClass.match(/tablet\d/).join().slice(-1) : 2,
					sliderColumnsMobile = sliderClass.match(/mobile\d/) ? sliderClass.match(/mobile\d/).join().slice(-1) : 1;
					...
					responsive: [
						{
							breakpoint: 10000,
							settings: {
							  slidesToShow: sliderClass.match(/widescreen\d/) ? sliderClass.match(/widescreen\d/).join().slice(-1) : sliderColumnsDesktop,
							}
						},
						{
							breakpoint: 2399,
						...
						},
						{
							breakpoint: 1221,
							settings: {
							  slidesToShow: sliderClass.match(/laptop\d/) ? sliderClass.match(/laptop\d/).join().slice(-1) : sliderColumnsDesktop,
							}
						},
						{
							breakpoint: 1200,
							settings: {
							  slidesToShow: sliderClass.match(/tablet_extra\d/) ? sliderClass.match(/tablet_extra\d/).join().slice(-1) : sliderColumnsTablet,
							}
						},
						{
						  breakpoint: 1024,
						...
						},
						{
						  breakpoint: 880,
						  settings: {
							slidesToShow: sliderClass.match(/mobile_extra\d/) ? sliderClass.match(/mobile_extra\d/).join().slice(-1) : sliderColumnsTablet,
						  }
						},
						{
						  breakpoint: 768,
