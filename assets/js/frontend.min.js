  ...
  ( function( $, elementor ) {
	...
	var WprElements = {
		...
		init: function(elementor) {
            ...
            function myFunction() {
                if(document.getElementById('wpr-mybar')) {
                    var winScroll = document.body.scrollTop || document.documentElement.scrollTop;
                    var height = document.documentElement.scrollHeight - document.documentElement.clientHeight;
                    var scrolled = (winScroll / height) * 100;
                    document.getElementById("wpr-mybar").style.width = scrolled + "%";
				}
			}
			if( $('#wpadminbar').length && $('.wpr-progress-container') ) {
				// var adminBarHeight2 = $('#wpadminbar').css('height').slice(0, $('#wpadminbar').css('height').length - 2);
				var adminBarHeight2 = $('#wpadminbar').css('height').slice(0, -2);
				var progressBarPositionTop = $('.wpr-progress-container').css('top').slice(0, -2);
				// var progressBarPositionBottom = $('.wpr-progress-container').css('botom').slice(0, -2);
				// console.log(progressBarPositionBottom, progressBarPositionTop);
				console.log(adminBarHeight2);
				if(adminBarHeight2 > progressBarPositionTop ) {
					console.log(adminBarHeight2 - progressBarPositionTop);
					$('.wpr-progress-container').css('top', progressBarPositionTop + (adminBarHeight2 - progressBarPositionTop) + 'px');
					$('.wpr-progress-container').css('bottom', 'auto'); 
				}
			}
		},
