( function( $, elementor ) {
	...
	var WprElements = {
		...
		widgetCharts: function($scope) {
			...
			var chartPadding = window.innerWidth >= 768 ? chartSettings.chart_padding : chartSettings.chart_padding_mobile;
			// var tooltipCaretSize = window.innerWidth >= 768 ? chartSettings.tooltip_caret_size : chartSettings.chart_tooltip_caret_size_mobile;
			var tooltipCaretSize = chartSettings.tooltip_caret_size;
			...
			var globalOptions = {
				...
				layout: { // needs other approach
					padding: chartSettings.chartPadding,
				},
			...
			$(window).resize(function() {
				lineDotsWidth = window.innerWidth >= 768 ? chartSettings.line_dots_radius 
									: window.innerWidth <= 767 ? chartSettings.line_dots_radius_mobile : 0;
				chartPadding = window.innerWidth >= 768 ? chartSettings.chart_padding : chartSettings.chart_padding_mobile;
				// tooltipCaretSize = window.innerWidth >= 768 ? chartSettings.tooltip_caret_size : chartSettings.tooltip_caret_size_mobile;
				myChart.config.options.layout.padding = chartPadding;
				myChart.config.options.elements.point.radius = lineDotsWidth;
				// myChart.config.options.plugins.tooltip.caretSize = tooltipCaretSize;
			});
