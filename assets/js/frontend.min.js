			...
			function parallaxBackground() {
				if ( $scope.hasClass('wpr-jarallax-yes') ) {
					if ( ! WprElements.editorCheck() && $scope.hasClass('wpr-jarallax') ) {
                        var backgroundImage = window.innerWidth <= 767 ? $scope.attr('bg-image-mobile') : $scope.attr('bg-image');
                        ...
                        $(window).resize(function(){
                            backgroundImage = window.innerWidth <= 767 ? $scope.attr('bg-image-mobile') : $scope.attr('bg-image');

                            // $scope.css('background-image', 'url("' + backgroundImage + '")');
                            $scope.attr('data-jarallax-original-styles', 'background-image: url("'+backgroundImage+'")');
                            // $scope.find('div[id*="jarallax-container"] div').css('background-image', 'url("' + backgroundImage + '")');
                            $scope.find('div[id*="jarallax-container"] img').attr('src', backgroundImage);
						...
						var backgroundImage = window.innerWidth <= 767 ? $scope.find('.wpr-jarallax').attr('bg-image-mobile-editor') : $scope.find('.wpr-jarallax').attr('bg-image-editor');
                        ...
                        $(window).resize(function(){
                            backgroundImage = window.innerWidth <= 767 ? ($scope.find('.wpr-jarallax').attr('bg-image-mobile-editor') !== '' ? $scope.find('.wpr-jarallax').attr('bg-image-mobile-editor') : $scope.find('.wpr-jarallax').attr('bg-image-editor')) : $scope.find('.wpr-jarallax').attr('bg-image-editor');
							console.log($scope.find('.wpr-jarallax').attr('bg-image-mobile-editor'));
