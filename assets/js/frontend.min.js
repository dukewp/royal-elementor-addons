		...
		widgetSection: function( $scope ) {
			...
			if( $scope.hasClass('wpr-sticky-section-yes') ) {
				var positionType = !WprElements.editorCheck() ? $scope.attr('data-wpr-position-type') : $scope.find('.wpr-sticky-section-yes-editor').attr('data-wpr-position-type'),
					...
					responsiveCondition = !WprElements.editorCheck() ? $scope.attr('data-wpr-sticky-devices') : $scope.find('.wpr-sticky-section-yes-editor').attr('data-wpr-sticky-devices');

				if( WprElements.editorCheck() && responsiveCondition ) {
					var attributes = $scope.find('.wpr-sticky-section-yes-editor').attr('data-wpr-sticky-devices');
						...
						responsiveCondition = $scope.attr('data-wpr-sticky-devices');
				}
				var positionStyle;
				// $(window).resize(function(){
					if ( viewportWidth >= 1215 && responsiveCondition.indexOf('desktop_sticky') == -1 ) {
						positionStyle = 'relative';
					
						console.log(responsiveCondition.indexOf('desktop_sticky') == -1);
						console.log(positionStyle);
					} else if ( (768 <= viewportWidth && 1025 > viewportWidth) && responsiveCondition.indexOf('tablet_sticky') == -1 ) {
						positionStyle = 'relative';
					
						console.log(responsiveCondition.indexOf('tablet_sticky') == -1);
						console.log(positionStyle);
					} else {
				...
				// 		positionType = $scope.css('position');
				// 	elementOffset += 32;		
