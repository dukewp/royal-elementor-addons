( function( $, elementor ) {
	...
	var WprElements = {
		...
		widgetPageMyAccount: function($scope) {
			...
			class MyAccountClass extends elementorModules.frontend.handles.Base {
				getDefaultSettings() {
					return {
						selectors: {
							button: '.woocommerce-MyAccount-navigation-link',
						},
					};
				}
			}
			...
			console.log(myAccount.getSettings('selectors'));
			// $e.commands.getAll();
