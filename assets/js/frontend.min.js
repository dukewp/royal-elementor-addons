( function( $, elementor ) {
	...
	var WprElements = {
		...
		widgetSection: function( $scope ) {
			...
			// 		// 	var responsiveCondition = $scope.attr('data-wpr-sticky-devices', attributes);
			// 		// }
			...
			// 		console.log(responsiveCondition.indexOf('widescreen_sticky') > -1, viewportWidth);

			// 		if( viewportWidth >= 2400 && responsiveCondition.indexOf('widescreen_sticky') > -1 ) {
			...
			// 		}
			// 		else {	
			// 			$scope.css({ 'position': positionType, 'bottom': elementOffset + 'px', 'top': 'auto', 'width': '100%' }) ;
			// 		}
