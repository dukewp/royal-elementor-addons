			...
			if ($scope.find('.wpr-table-th').length > 8) {
				...
				$(document).on('click', '.wpr-table-tr-before', function() {
						...
						if( !$(this).closest('.wpr-table-row').next('.wpr-table-appended-tr').length ) {
							...
							appendedTr[$(this).closest('.wpr-table-row').index()] = '<tr class="wpr-table-appended-tr"><td class="wpr-table-appended-td" style="width: 100%; text-align: center;"><ul class="appended-ul">'+ thisItemText.toString().replace(/,/g, '') +'</ul></td></tr>';
