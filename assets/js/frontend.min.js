	...
	var WprElements = {
		...
		jarallaxTest: function( $scope ) {
			if ( $scope.hasClass('jarallax-yes') ) {
				// console.log($scope.attr('class'), $scope.attr('speed-data'),  $scope.attr('bg-image'));
				// $scope.css('background-image', 'url("' + $scope.attr('bg-image').split(' ')[0] + '")');
				$scope.css('background-image', 'url("https://source.unsplash.com/random")');
				$scope.jarallax({
