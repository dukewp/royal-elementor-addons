	...
	var WprElements = {
		...
		init: function(elementor) {
			...
			if( $('#wpadminbar').length && $('.wpr-progress-container') ) {
				...
				var progressBarPosition = $('.wpr-progress-container').css('top').slice(0, -2);
				console.log(adminBarHeight2, progressBarPosition);
				if(adminBarHeight2 > progressBarPosition) {
					console.log(adminBarHeight2 - progressBarPosition);
					$('.wpr-progress-container').css('top', progressBarPosition + (adminBarHeight2 - progressBarPosition) + 'px');
