( function( $, elementor ) {
	...
	var WprElements = {
        ...
        widgetInstagramFeed: function($scope) {
			...
			// 	get: 'user',
			// 	userId: [2241215352],
			// 	accessToken: '[IGQVJYN1QxQ3JzMHEtUGQ4M3prc3B5R0E2ZAUlpaVFqS0dZAUk14VE9yYkFRYU01bDU4OHBYYUw2ZAEIxOW5wNW1DcV9NY0hFSGl3d1dINGdJazZAUV21YaUpQMFY3ZAVNYQ3lSSXJMSjlQU3ZA5elRkWFVCdAZDZD]',
			...
			var feed = new Instafeed({
				accessToken: WprConfig.insta_access_token
			});
			feed.run();
