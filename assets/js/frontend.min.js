		...
		widgetAdvancedTable: function($scope) {
			...
			if ( 'yes' === $scope.find('.wpr-table-inner-container').attr('data-custom-pagination') ) {
				...
				$(document).on('click', '.wpr-table-custom-pagination-list-item', function() {
						...
						console.log('click-target-index', $(this).index());
						adjustPaginationList();
						table.hide();
						pageIndex = +$(this).text();
						itemsPerPage = +$scope.find('.wpr-table-inner-container').attr('data-rows-per-page');
			...
			var tableColumns =  '' !== ($scope.find('.wpr-table-inner-container').attr('data-table-columns')) ? ($scope.find('.wpr-table-inner-container').attr('data-table-columns')) : '';

			if ($scope.find('.wpr-table-th').length > tableColumns && tableColumns !== '') {
			...
			function adjustPaginationList() {
				...
				console.log('outside-each', paginationIndex);
				console.log('pag-length', paginationListItems.length);
				paginationListItems.each(function(index) {
					console.log('inside-each', paginationIndex);
