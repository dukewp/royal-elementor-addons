	...
	var WprElements = {
		...
		init: function() {
			...
			var widgets = {
				...
				'wpr-product-tabs.default' : WprElements.widgetProductTabs,
		...
		widgetProductTabs: function( $scope ) {
			...
			var $tabList = $scope.find( '.wc-tabs li' );
				// tabsData = $tabs.data('options');

			var activeTabIndex = 0; //tabsData.activeTab - 1
				$tabList.eq( activeTabIndex ).addClass( 'active' );
				$scope.find('.woocommerce-Tabs-panel').css('display', 'none');
				$scope.find('.woocommerce-Tabs-panel').eq(activeTabIndex).css('display', 'block');

				// $scope.find('p.stars a').on('click', function() {
				// 	$(this).addClass('active');
				// });

				// $scope.find('p.stars a').each(function() {
				// 	if ( $(this).index() < $scope.find('p.stars a.active').index()) {
				// 		console.log('works');
				// 		$(this).addClass('active');
				// 	}
				// });
		}, // End widgetProductTabs
