( function( $, elementor ) {
	...
	var WprElements = {
        ...
        widgetImageAccordion: function($scope) {
			var lightboxSettings = $scope.find( '.wpr-img-accordion-media-hover' ).attr( 'data-settings' );
			...
			if($scope.hasClass('wpr-image-accordion-interaction-click')) {
				var accordionItem = $scope.find('.wpr-image-accordion-item');
			}

			console.log($scope, accordionItem);
