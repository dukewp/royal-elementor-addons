	...
	var WprElements = {
		...
		init: function() {
			...
			var widgets = {
				...
				// 'wpr-products-result-count.default' : WprElements.widgetProductsResultCount,
		...
		widgetProductMiniCart: function($scope) {
				...
				if ( $scope.hasClass('wpr-mini-cart-sidebar') ) {
					$scope.find('.wpr-shopping-cart-wrap').css('top', $('#wpadminbar').css('height'));
					...
					$scope.find('.wpr-close-cart span').on('click', function(e) {
						...
						$scope.find('.wpr-shopping-cart-wrap').fadeOut(600);
						setTimeout(function() {
				...
				$scope.find('.wpr-mini-cart-toggle-btn').on('click', function(e) {
					...
					if( 'none' === $scope.find('.wpr-mini-cart').css("display") ) {
						...
						if ( $scope.hasClass('wpr-mini-cart-sidebar') ) {
							$scope.find('.wpr-shopping-cart-wrap').fadeIn(600);
