( function( $, elementor ) {
	...
	var WprElements = {
		...
		widgetAdvancedAccordion: function($scope) {
			...
			var interactionSpeed = +$scope.find('.wpr-advanced-accordion').data('interaction-speed');
				...
				if ( accordionType == 'accordion' ) {
						acc.on("click", function() {
							...
							acc.each(function(index){
								index != thisIndex ? $(this).removeClass('active') : '';
							});
							$scope.find('.panel').each(function(index) {
								index != thisIndex ? $(this).removeClass('wpr-accordion-panel-active') : '';
								$(this).slideUp(interactionSpeed);
							});
							$(this).toggleClass("active");
							var panel = $(this).next();
							if ( !panel.hasClass('wpr-accordion-panel-active') ) {
								panel.slideDown(interactionSpeed);
								panel.addClass('wpr-accordion-panel-active');
							} else {
								panel.slideUp(interactionSpeed);
								panel.removeClass('wpr-accordion-panel-active');
							}
						});
				} else {
					acc.each(function() {
