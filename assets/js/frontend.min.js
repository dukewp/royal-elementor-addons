	...
	var WprElements = {
		...
		widgetSection: function( $scope ) {
			if( $scope.attr('data-wpr-particles') || $scope.find('.wpr-particle-wrapper').attr('data-wpr-particles-editor') ) {
				WprElements.particlesTest($scope);
            } 
			if ( $scope.hasClass('jarallax') || $scope.hasClass('jarallax-yes') ) {
				WprElements.jarallaxTest($scope);
			}
		}, // end widgetSection

		particlesTest: function( $scope ) {
				...
				if ( 'section' === elementType && undefined !== particlesJSON ) {
					...
					if ( ! WprElements.editorCheck() ) {
						...
						particlesJS('wpr-particle-'+ sectionID, JSON.parse(particlesJSON));
		...
		jarallaxTest: function( $scope ) {
			if ( $scope.hasClass('jarallax-yes') ) {
				console.log($scope.attr('class'), $scope.attr('speed-data'));
				if(! WprElements.editorCheck() && $scope.hasClass('jarallax')) {
					$scope.attr('bg-image');
					$scope.css('background-image', 'url("' + $scope.attr('bg-image') + '")');
					$scope.jarallax({
						speed: $scope.attr('speed-data') ? $scope.attr('speed-data') : 0.3,
						imgWidth: 1366,
						imgHeight: 768,
						onScroll: function(calculation) {
							$scope.each(function(){
								if(calculation.visiblePercent == 1 && $(this).attr('scroll-effect') == 'fade') {
									// console.log('effected', calculation);
									$(this).addClass('jarallax-fade');
								} else {
									// console.log('not effected', calculation);
									$(this).removeClass('jarallax-fade');
								}
								if(calculation.visiblePercent == 1 && $(this).attr('scroll-effect') == 'zoom') {
									// console.log('effected', calculation);
									$(this).addClass('jarallax-zoom');
								} else {
									// console.log('not effected', calculation);
									$(this).removeClass('jarallax-zoom');
								}
								if(calculation.visiblePercent == 1 && $(this).attr('scroll-effect') == 'shade') {
									// console.log('effected', calculation);
									$(this).addClass('jarallax-shade');
								} else {
									// console.log('not effected', calculation);
									$(this).removeClass('jarallax-shade');
								}
								if(calculation.visiblePercent == 1 && $(this).attr('scroll-effect') == 'motion') {
									// console.log('effected', calculation);
									$(this).addClass('jarallax-motion');
								} else {
									// console.log('not effected', calculation);
									$(this).removeClass('jarallax-motion');
								}
							});
					...
					console.log($scope.find('.wpr-jarallax').attr('bg-image-editor'));
					...
					$scope.jarallax({
						...
						imgHeight: 768,
						onScroll: function(calculation) {
							$scope.find('.wpr-jarallax').each(function(){
								console.log($(this));
								if(calculation.visiblePercent == 1 && $(this).attr('scroll-effect-editor') == 'fade') {
									// console.log('effected', calculation);
									$scope.addClass('jarallax-fade');
								} else {
									// console.log('not effected', calculation);
									$scope.removeClass('jarallax-fade');
								}
								if(calculation.visiblePercent == 1 && $(this).attr('scroll-effect-editor') == 'zoom') {
									// console.log('effected', calculation);
									$scope.addClass('jarallax-zoom');
								} else {
									// console.log('not effected', calculation);
									$scope.removeClass('jarallax-zoom');
								}
								if(calculation.visiblePercent == 1 && $(this).attr('scroll-effect-editor') == 'shade') {
									// console.log('effected', calculation);
									$scope.addClass('jarallax-shade');
								} else {
									// console.log('not effected', calculation);
									$scope.removeClass('jarallax-shade');
								}
								if(calculation.visiblePercent == 1 && $(this).attr('scroll-effect-editor') == 'motion') {
									// console.log('effected', calculation);
									$scope.addClass('jarallax-motion');
								} else {
									// console.log('not effected', calculation);
									$scope.removeClass('jarallax-motion');
								}
							});
							// console.log(calculation);
						},
