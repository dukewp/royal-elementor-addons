	...
	var WprElements = {
		...
		widgetGrid: function( $scope ) {
			...
			// Slider
				...
				var sliderClass = $scope.attr('class'),
					...
					slideSlidesToScroll = +(sliderClass.match(/wpr-grid-slides-to-scroll-\d/).join().slice(-1));
					...
					responsive: [
						{
							...
							settings: {
								...
								slidesToScroll: slideSlidesToScroll > sliderColumnsWideScreen ? 1 : slideSlidesToScroll
							}
						},
						{
							breakpoint: 2399,
							settings: {
								slidesToShow: sliderColumnsDesktop,
								slidesToScroll: slideSlidesToScroll > sliderColumnsDesktop ? 1 : slideSlidesToScroll
							}
						},
						{
							breakpoint: 1221,
							settings: {
								...
								slidesToScroll: slideSlidesToScroll > sliderColumnsLaptop ? 1 : slideSlidesToScroll
							}
						},
						{
							breakpoint: 1200,
							settings: {
								...
								slidesToScroll: slideSlidesToScroll > sliderColumnsTabletExtra ? 1 : slideSlidesToScroll
							}
						},
						{
							breakpoint: 1024,
							settings: {
								...
								slidesToScroll: slideSlidesToScroll > sliderColumnsTablet ? 1 : slideSlidesToScroll
							}
						},
						{
							breakpoint: 880,
							settings: {
								slidesToShow: sliderColumnsMobileExtra,
							 	slidesToScroll: slideSlidesToScroll > sliderColumnsMobileExtra ? 1 : slideSlidesToScroll
							}
						},
						{
							breakpoint: 768,
							settings: {
								...
								slidesToScroll: slideSlidesToScroll > sliderColumnsMobile ? 1 : slideSlidesToScroll
							}
						}
					],
				});
		...
		widgetAdvancedSlider: function( $scope ) {
			...
			var sliderClass = $scope.attr('class'),
				...
				sliderColumnsMobileExtra = sliderClass.match(/columns--mobile_extra\d/) ? sliderClass.match(/columns--mobile_extra\d/).join().slice(-1) : sliderColumnsTablet,
				sliderColumnsMobile = sliderClass.match(/columns--mobile\d/) ? sliderClass.match(/columns--mobile\d/).join().slice(-1) : 1,
				slideSlidesToScroll = +(sliderClass.match(/wpr-adv-slides-to-scroll-\d/).join().slice(-1)),
		...
		widgetContentTicker: function( $scope ) {
			...
			var sliderClass = $scope.attr('class'),
				...
				slideSlidesToScroll = 'hr-slide' === dataSlideEffect && sliderClass.match(/wpr-ticker-slides-to-scroll-\d/) ? +(sliderClass.match(/wpr-ticker-slides-to-scroll-\d/).join().slice(-1)) : 1;
				...
				responsive: [
					{
						breakpoint: 10000,
						settings: {
							slidesToShow: 'typing' === dataSlideEffect ? 1 : sliderColumnsWideScreen,
							slidesToScroll: slideSlidesToScroll > sliderColumnsWideScreen ? 1 : slideSlidesToScroll,
							fade: ((1 == sliderColumnsWideScreen && 'fade' === dataSlideEffect) || 'typing' === dataSlideEffect) ? true : false
						}
					},
					{
						breakpoint: 2399,
						settings: {
							slidesToShow: 'typing' === dataSlideEffect ? 1 : sliderColumnsDesktop,
							slidesToScroll: slideSlidesToScroll > sliderColumnsDesktop ? 1 : slideSlidesToScroll,
							fade: ((1 == sliderColumnsDesktop && 'fade' === dataSlideEffect) || 'typing' === dataSlideEffect) ? true : false
						}
					},
					{
						breakpoint: 1221,
						settings: {
							slidesToShow: 'typing' === dataSlideEffect ? 1 : sliderColumnsLaptop,
							slidesToScroll: slideSlidesToScroll > sliderColumnsLaptop ? 1 : slideSlidesToScroll,
							fade: ((1 == sliderColumnsLaptop && 'fade' === dataSlideEffect) || 'typing' === dataSlideEffect) ? true : false
						}
					},
					{
						breakpoint: 1200,
						settings: {
							slidesToShow: 'typing' === dataSlideEffect ? 1 : sliderColumnsTabletExtra,
							slidesToScroll: slideSlidesToScroll > sliderColumnsTabletExtra ? 1 : slideSlidesToScroll,
							fade: ((1 == sliderColumnsTabletExtra && 'fade' === dataSlideEffect) || 'typing' === dataSlideEffect) ? true : false
						}
					},
					{
						breakpoint: 1024,
						settings: {
							slidesToShow: 'typing' === dataSlideEffect ? 1 : sliderColumnsTablet,
							slidesToScroll: slideSlidesToScroll > sliderColumnsTablet ? 1 : slideSlidesToScroll,
							fade: ((1 == sliderColumnsTablet && 'fade' === dataSlideEffect) || 'typing' === dataSlideEffect) ? true : false
						}
					},
					{
						breakpoint: 880,
						settings: {
							slidesToShow: 'typing' === dataSlideEffect ? 1 : sliderColumnsMobileExtra,
						 	slidesToScroll: slideSlidesToScroll > sliderColumnsMobileExtra ? 1 : slideSlidesToScroll,
							fade: ((1 == sliderColumnsMobileExtra && 'fade' === dataSlideEffect) || 'typing' === dataSlideEffect) ? true : false
						}
					},
					{
						breakpoint: 768,
						settings: {
							slidesToShow: 'typing' === dataSlideEffect ? 1 : sliderColumnsMobile,
							slidesToScroll: slideSlidesToScroll > sliderColumnsMobile ? 1 : slideSlidesToScroll,
							fade: ((1 == sliderColumnsMobile && 'fade' === dataSlideEffect) || 'typing' === dataSlideEffect) ? true : false
						}
					}
				],
			});
