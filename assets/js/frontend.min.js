	...
	var WprElements = {
		...
		widgetPostsTimeline: function($scope) { // goback
		  ...
		  function adjustMiddleLineHeight(middleLine, timelineFill, lastIcon, firstIcon, element) {
				...
				var middleLineHeight = lastIcon.offset().top - firstIcon.offset().top + parseInt(lastIcon.css('height').slice(0, -2));
				var middleLineMaxHeight = firstIconOffset - lastIconOffset + 'px !important';
				var timelineFillTop = (firstIconOffset - element.offset().top) + 'px';

				console.log(firstIconOffset, lastIconOffset, middleLineTop, middleLineHeight, middleLineMaxHeight, timelineFillTop);

				middleLine.css('top', middleLineTop);
				middleLine.css('height', middleLineHeight);
				middleLine.css('maxHeight', middleLineMaxHeight);
				timelineFill !== '' ? timelineFill.css('top', timelineFillTop) : '';
