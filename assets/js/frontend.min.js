( function( $, elementor ) {
	...
	var WprElements = {
		...
		widgetProductAddToCart: function($scope) {// Quantity Inputs
			var qtyInput = jQuery('.woocommerce .quantity').not('.mini_cart_item .quantity'),
				...
				plusIcon = $scope.find('.wpr-product-add-to-cart').attr('quantity-plus-icon');
				minusIcon = $scope.find('.wpr-product-add-to-cart').attr('quantity-minus-icon');

				console.log(qtyLayout);
			...
			// add arrows
			if ( 'both' === qtyLayout ) {
				qtyInput.prepend('<i class="'+minusIcon+' minus"></i>');
				qtyInput.append('<i class="'+plusIcon+' plus"></i>');
			} else if ( 'before' === qtyLayout ) {
				qtyInput.prepend('<div class="wpr-add-to-cart-icons-wrap"><i class="'+plusIcon+' plus"></i><i class="fa fa-minus minus"></i></div>');
			} else if ( 'after' === qtyLayout ) {
				qtyInput.append('<div class="wpr-add-to-cart-icons-wrap"><i class="fa fa-plus plus"></i><i class="fa fa-minus minus"></i></div>');
			}
		
			// plus
			qtyInput.on('click', '.plus', function() {
				if ( parseInt(jQuery(this).closest('.quantity').closest('.quantity').find('input.qty').val(), 10) < qtyInputInStock ) {
					jQuery(this).closest('.quantity').find('input.qty').val( parseInt(jQuery(this).closest('.quantity').find('input.qty').val(), 10) + 1);
			...
			qtyInput.on('click', '.minus', function() {
				if ( parseInt(jQuery(this).closest('.quantity').find('input.qty').val(), 10) > 0 ) {
