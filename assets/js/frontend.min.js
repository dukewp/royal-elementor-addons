	...
	var WprElements = {
		...
		init: function() {
			...
			var widgets = {
				...
				'global/1': WprElements.widgetSection,
				'global/2': WprElements.jarallaxTest,
			};
        ...
        jarallaxTest: function( $scope ) {
			if($scope.hasClass('jarallax') && !WprElements.editorCheck()) {
				console.log($scope.hasClass('jarallax'));

				// console.log($scope.attr('class'), $scope.attr('speed-data'),  $scope.attr('bg-image'));
				$('.jarallax').css('background-image', 'url("' + $scope.attr('bg-image').split(' ')[0] + '")');
				$scope.jarallax({
				...
				$('.jarallax').css('background-image', 'url("https://source.unsplash.com/random")');
				// $scope.jarallax({
				// 	speed: 0.2
				// });
