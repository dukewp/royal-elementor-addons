( function( $, elementor ) {
	...
	var WprElements = {
		...
		widgetCharts: function($scope) {
			...
			var customDatasets = JSON.parse(chartSettings.chart_datasets);
			console.log(chartSettings.legend_padding);
			var globalOptions = {
				responsive: true,
				...
				// 	}
				// }, // specify exact inserting way
				events: [chartSettings.trigger_tooltip_on],
				interaction: {
					// Overrides the global setting
					mode: chartSettings.chart_interaction_mode
				},
				elements: {
					point: {
						radius: chartSettings.line_dots === 'yes' ? chartSettings.line_dots_radius : 0 // default to disabled in all datasets
					}
				},
				...
				plugins: {
					layout: { // needs other approach
						padding: chartSettings.chart_padding,
					},
					legend: {
						...
						// padding: chartSettings.legend_padding !== undefined ? chartSsettings.legend_padding : 10,
						labels: {
