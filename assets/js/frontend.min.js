( function( $, elementor ) {
	...
	var WprElements = {
		...
		widgetAdvancedTable: function($scope) {
			...
			if ($scope.find('.wpr-table-th').length > 8) {
				...
				$(document).on('click', '.wpr-table-tr-before', function() {
						...
						var colspanNum = 'yes' === $scope.find('.wpr-table-inner-container').attr('data-row-pagination') ? 9 : 8;
			...
			if ( $scope.find('.wpr-table-inner-container').attr('data-row-pagination') ) {
