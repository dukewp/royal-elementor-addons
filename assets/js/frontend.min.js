( function( $, elementor ) {
	...
	var WprElements = {
		...
		particlesTest: function( $scope ) {
			...
			if ( 'section' === elementType && undefined !== particlesJSON ) {
				...
				if ( ! WprElements.editorCheck() ) {
					...
					particlesJS('wpr-particle-'+ sectionID, WprElements.modifyJSON($scope, particlesJSON));
				// Editor
				} else {
					if ( $scope.hasClass('wpr-particle-yes') ) {
						console.log($scope.find('.wpr-particle-wrapper').attr('wpr-quantity'));
						console.log($scope.find('.wpr-particle-wrapper').attr('wpr-color'));
						console.log($scope.find('.wpr-particle-wrapper').attr('wpr-speed'));
						console.log(typeof $scope.find('.wpr-particle-wrapper').attr('wpr-size'));
						particlesJS( 'wpr-particle-'+ sectionID, WprElements.modifyJSON($scope, particlesJSON));	
		...
		modifyJSON: function($scope, json) {
			...
			wp_json.particles.number.value = particles_quantity;
			wp_json.particles.color.value = particles_color;
			wp_json.particles.shape.type = particles_shape;
			wp_json.particles.line_linked.color = particles_color;
			wp_json.particles.move.speed = particles_speed;
			wp_json.particles.size.value = particles_size;
