		...
		widgetSection: function( $scope ) {
			...
			if ( $scope.hasClass('wpr-sticky-section-yes') ) {
			    ...
			    var positionType = !WprElements.editorCheck() ? $scope.attr('data-wpr-position-type') : $scope.find('.wpr-sticky-section-yes-editor').attr('data-wpr-position-type'),
				    ...
				    scopePlaceholder = $scope.closest('div[data-elementor-type="wp-post"]').length ? $scope.closest('div[data-elementor-type="wp-post"]') : '';
			    ...
			    function applyPosition() {
			        ...
			        if ( 'top'  ===  positionLocation ) {
			            ...
			            if ( '' !== scopePlaceholder ) {
			                // scopePlaceholder = scopePlaceholder.find('.wpr-sticky-section-yes');
			                scopePlaceholder.css({'position': positionStyle, 'top': positionOffset + 'px', 'bottom': 'auto', 'z-index': 99999999 });
			            }
			        }
			        else {
			            $scope.css({'position': positionStyle });
			            if ( '' !== scopePlaceholder ) {
			                scopePlaceholder = scopePlaceholder.find('.wpr-sticky-section-yes');
			                scopePlaceholder.css({'position': positionStyle, 'bottom': positionOffset + 'px', 'top': 'auto', 'z-index': 99999999 });
			            }
			        }
			    }
