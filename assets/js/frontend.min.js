	...
	var WprElements = {
		...
		widgetSection: function( $scope ) {
			...
			if ( $scope.hasClass("wpr-equal-height-yes") )  {
				elementorFrontend.hooks.addAction("frontend/element_ready/section", WprEqualHeight);
				elementorFrontend.hooks.addAction("frontend/element_ready/container", WprEqualHeight);
			}
			...
			function WprEqualHeight($scope) {
				...
				var enableOn = equalHeightSettings.enable_on;
				...
				function triggerEqualHeight() {
					if (enableOn.includes(elementorFrontend.getCurrentDeviceMode()) && 0 !== equalHeightSettings.wpr_eh_target.length) {
						equalHeightSettings.wpr_eh_target.forEach(function (target) {
							matchHeight(target);
						});
					} else {
						section.find(equalHeightSettings.wpr_eh_target).css('minHeight', 'unset');
					}
				}
		...
		widgetGrid: function( $scope ) {
			...
			function isotopeLayout( settings ) {
				...
				// Mobile
				if ( elementorFrontend.config.responsive.breakpoints.mobile.value >= viewportWidth ) {
					columns = columnsMobile;
				// Mobile Extra
				} else if ( elementorFrontend.config.responsive.breakpoints.mobile_extra.value >= viewportWidth ) {
					columns = (columnsMobileExtra) ? columnsMobileExtra : columnsTablet;

				// Tablet
				} else if ( elementorFrontend.config.responsive.breakpoints.tablet.value >= viewportWidth ) {
					columns = columnsTablet;
				// Tablet Extra
				} else if ( elementorFrontend.config.responsive.breakpoints.tablet_extra.value >= viewportWidth ) {
					columns = (columnsTabletExtra) ? columnsTabletExtra : columnsTablet;

				// Laptop
				} else if ( elementorFrontend.config.responsive.breakpoints.laptop.value >= viewportWidth ) {
				...
				// Widescreen
				} else if ( elementorFrontend.config.responsive.breakpoints.widescreen.value >= viewportWidth ) {
