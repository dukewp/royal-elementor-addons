( function( $, elementor ) {
	...
	var WprElements = {
		...
		widgetProductAddToCart: function($scope) {
			...
			// plus
			qtyInput.on('click', 'i:last-child', function() {
			...
			// minus
			qtyInput.on('click', 'i:first-child', function() {
		...
		widgetPageMyAccount: function($scope) {
			...
			class MyAccountHandler extends elementorModules.frontend.handlers.Base {

				getDefaultSettings() {
					return {
						selectors: {
							firstSelector: '.woocommerce-MyAccount-navigation-link',
						},
					};
				}
			...
			console.log(elementorFrontend.elementsHandler.addHandler);

			elementorFrontend.elementsHandler.addHandler( MyAccountHandler, {
				$scope,
			} );
