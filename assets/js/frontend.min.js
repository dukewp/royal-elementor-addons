( function( $, elementor ) {
	...
	var WprElements = {
		...
		widgetCharts: function($scope) {
			...
			console.log(chartSettings.data_source);
			...
			if ('custom' === chartSettings.data_source) {
				  ...
				  console.log(chartSettings.legend_position);
