( function( $, elementor ) {
	...
	var WprElements = {
		...
		widgetGrid: function( $scope ) {
			...
			// Init Media Hover Link
			mediaHoverLink();
			console.log(iGrid.find( '.wpr-grid-media-wrap' ).attr( 'data-overlay-link' ));
        ...
        widgetProductsResultCount: function ($scope) {
            var select = $scope.find(".wpr-addons-filter");
            $scope.find(".orderby").on("change", function () {
                console.log('works');
                select.trigger("submit");
            });
        }, // End of widgetProductsResultCount
