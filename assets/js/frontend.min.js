  ...
  ( function( $, elementor ) {
	...
	var WprElements = {
		...
		init: function(elementor) {
			...
			// 	  let wrpbHtml = '<div class="wpr-progress-container"><div class="wpr-progress-bar" id="wpr-mybar"></div></div>'; 
			// 	  // On Enable RPB
			// 	  elementor.settings.page.addChangeCallback( 'wpr_enable_reading_progress', function( value ) {
			// 		if( value == 'yes' ) {
