	...
	var WprElements = {
		...
		init: function() {
			...
			var widgets = {
				...
				'wpr-product-add-to-cart.default' : WprElements.addToCart,
		...
		addToCart: function($scope) {// Quantity Inputs
			...
			// add arrows
			if ( 'both' === qtyLayout ) {
				qtyInput.prepend('<i class="fa fa-minus minus"></i>');
				qtyInput.append('<i class="fa fa-plus plus"></i>');
			} else if ( 'before' === qtyLayout ) {
				qtyInput.prepend('<div class="wpr-add-to-cart-icons-wrap"><i class="fa fa-plus plus"></i><i class="fa fa-minus minus"></i></div>');
