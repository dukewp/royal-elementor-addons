( function( $ ) {
    ...
    $(window).on('elementor:init', function () {
        ...
        elementor.settings.page.addChangeCallback( 'wpr_rpb_enable', function ( newValue ) {
			...
			console.log('enable_progress_bar_library_front');
			console.log(newValue);
            if('yes' == newValue ) {
                let wrpbHtml = '<div class="wpr-reading-progress-bar-container"><div class="wpr-reading-progress-bar wpr-mybar" id="wpr-mybar"></div></div>'; // </div>
