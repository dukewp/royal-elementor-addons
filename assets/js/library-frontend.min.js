			...
			// Render Preview
				...
				previewIframe.find( '.wpr-tplib-template-media' ).on( 'click', function() {
					...
					if ( 'iframe' == previewType ) {
						...
						previewIframe.find('.wpr-tplib-preview-wrap').html( '<div class="wpr-tplib-image"><img src="'+ previewUrl +'?ref=rea-plugin-library-preview'+ proRefferal +'"></div>' );
					}
				});
				...
				previewIframe.find( '.wpr-tplib-insert-template' ).on( 'click', function() {
					...
					// Popup Templates
					if ( 'popups' === previewIframe.find('.wpr-tplib-header').find('li.wpr-tplib-active-tab').data('tab') ) {
