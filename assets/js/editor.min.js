( function( $ ) {//TODO: manage comments
	...
	// Advanced Table
	elementor.hooks.addAction( 'panel/open_editor/widget/wpr-advanced-table', function( panel, model, view ) {
		
		panel.$el.find('#elementor-controls').on( 'DOMNodeInserted ', '.elementor-control-table_export_csv_button', function() {

			$(this).find('button[data-event="my-table-export"]').on("click", function () {
				var html = view.$el.find('.wpr-advanced-table');
				fnExcelReport(html);
				// var html = view.$el.find('.wpr-advanced-table').prop('outerHTML');
	...
	function htmlToCSV(html, filename, view) {
		var data = [];
		var rows = view.$el.find('.wpr-advanced-table').find(".wpr-table-row");
