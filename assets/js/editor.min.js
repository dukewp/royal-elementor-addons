( function( $ ) {//TODO: manage comments
	...
	// Elementor Panel Loaded
	var editorOpenTimeout = setInterval(function() {
		if ( $('#elementor-panel-elements-search-input').length ) {
			clearTimeout(editorOpenTimeout);
		}
		...
		$('#elementor-panel-elements-search-input').on( 'keyup', function(e) {
			...
			searchTimeout = setTimeout(function() {
				...
				$.ajax({
					...
					url: ajaxurl,
					data: {
						action: 'wpr_elementor_search_data',
						search_query: val
					},
					success: function( response ) {
						console.log(response)
						console.log('data sent! - '+ val)
					}
				});
			}, 1000);
		});
