( function( $ ) {//TODO: manage comments
	...
	// elementor.hooks.doAction("editMode.init");

	// elementor.hooks.addAction('editMode.init', function() {
	//     console.log(elementor.settings.page, elementor.pageSettings);
	// });
	// elementor.settings.page.addChangeCallback( 'wpr_enable_reading_progress', function ( newValue ) {
	//     console.log( newValue );
	//     elementor.reloadPreview();
	// });

	// elementor.pageSettings.addChangeCallback( 'wpr_enable_reading_progress', function( newValue ) {
	//     // Here you can do as you wish with the newValue
	//     console.log( newValue );
	//     elementor.reloadPreview();
	// } );

	console.log(elementor.settings.page);
