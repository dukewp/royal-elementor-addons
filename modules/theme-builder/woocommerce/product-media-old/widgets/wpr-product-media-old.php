<?php
namespace WprAddons\Modules\ThemeBuilder\Woocommerce\ProductMediaOld\Widgets;
...
class Wpr_Product_Media_Old extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product Media Old', 'wpr-addons' );
	}
