		...
		return [
			'grocery-store' => [
				'v1' => [
					...
					'tags' => 'shop shopping woo-commerce woocommerc estore ecommerce product online eshopping portfolio market reseller ecommerce shop',
					'theme-builder' => false,
					'woo-builder' => true,
					'off-canvas' => false,
			...
			'furniture-shop' => [
				'v1' => [
					...
					'plugins' => '{"contact-form-7":'. $is_cf7_active .',"woocommerce":'. $is_woo_active .'}',
					'tags' => 'shop shopping woo-commerce woocommerc estore ecommerce product online furniture home office eshopping portfolio market reseller ecommerce shop ',
					'theme-builder' => false,
					'woo-builder' => true,
					'off-canvas' => true,
					'price' => $is_pro_active ? 'free' : 'pro',
			...
			'fashion' => [
				'v1' => [
					...
					'plugins' => '{"contact-form-7":'. $is_cf7_active .',"woocommerce":'. $is_woo_active .'}',
					'tags' => 'shop shopping woo-commerce woocommerc estore ecommerce product ecommerce shop online boutique clothes eshopping fashion portfolio designer market reseller digital purchases',
					'theme-builder' => true,
					'woo-builder' => true,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'pro',
			...
			'wooshop' => [
				'v1' => [
					...
					'plugins' => '{"contact-form-7":'. $is_cf7_active .',"woocommerce":'. $is_woo_active .'}',
					'tags' => 'shop shopping woo-commerce woocommerc estore ecommerce shop ecommerce product online shop online store boutique clothes eshopping fashion portfolio designer market reseller digital purchases',
					'theme-builder' => false,
					'woo-builder' => true,
					'off-canvas' => false,
