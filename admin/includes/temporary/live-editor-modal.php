...
<div class="wpr-live-editor-iframe-modal">
			...
			<div class="dialog-header dialog-lightbox-header">
				<div class="elementor-templates-modal__header">
						...
						<div class="elementor-templates-modal__header__logo">
							<span class="elementor-templates-modal__header__logo__icon-wrapper" id="pa-live-editor-logo">
								<span class="premium-template-modal-header-logo-icon">
									<img src="<?php echo esc_url( WPR_ADDONS_URL . 'assets/img/logo-40x40.png' ); ?>">
								</span>
							</span>
							...
							<div class="premium-live-editor-title">
								<input type="text" id="wpr-live-temp-title" name="premiumLiveTempTitle" placeholder="Enter template name...">
								<button id="wpr-insert-live-temp" class="elementor-template-library-template-action premium-template-insert elementor-button elementor-button-success" ><?php esc_html_e( 'Save & Insert Template', 'premium-addons-for-elementor' ); ?></button>
					...
					<div class="elementor-templates-modal__header__items-area">
						...
						<div class="elementor-templates-modal__header__expand  elementor-templates-modal__header__item wpr-expand-editor">
				...
				<div class="dialog-content dialog-lightbox-content" style="display: block;">
					<div id="elementor-template-library-templates" data-template-source="remote">
						...
						<div id="elementor-template-library-templates-container">
							<iframe id="wpr-live-editor-control-iframe"></iframe>
						</div>
					</div>
				</div>
